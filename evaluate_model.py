...
def generate_samples(netG, reals_shapes, noise_amp, scale_w=1.0, scale_h=1.0, reconstruct=False, n=50, im_name=""):
    ...
    if reconstruct:
        ...
        if opt.train_mode == "generation" or opt.train_mode == "retarget":
            functions.save_image('{}/{}_reconstruction.jpg'.format(dir2save, im_name), reconstruction.detach())
            ...
            functions.save_image('{}/{}_{}_wo_mask.jpg'.format(dir2save, _name, im_name), reconstruction.detach())
    ...
    if scale_w == 1. and scale_h == 1.:
        ...
        reals_shapes = [[r_shape[0], r_shape[1], int(r_shape[2] * scale_h), int(r_shape[3] * scale_w)] for r_shape in
                        reals_shapes]
